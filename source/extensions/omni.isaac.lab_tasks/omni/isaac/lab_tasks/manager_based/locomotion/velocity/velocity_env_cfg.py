...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        phase = ObsTerm(func=mdp.phase, params={"period": 0.3}, noise=Unoise(n_min=-0., n_max=0.))
...
class ObservationsCfgWPos:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # observation terms (order preserved)
        base_pos = ObsTerm(mdp.root_pos_w, noise=Unoise(n_min=-0.002, n_max=0.002))
        base_quat = ObsTerm(mdp.root_quat_w, noise=Unoise(n_min=-0.001, n_max=0.001))
...
@configclass
class LocomotionVelocityRoughWPosEnvCfg(LocomotionVelocityRoughEnvCfg):
    """Configuration for the locomotion velocity-tracking environment."""

    # Basic settings
    observations: ObservationsCfg = ObservationsCfgWPos()
