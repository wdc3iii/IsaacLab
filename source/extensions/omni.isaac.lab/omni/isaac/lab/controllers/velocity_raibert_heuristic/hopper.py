...
class VelocityRHHopper:
    ...
    def __init__(self, cfg: VelocityRHHopperCfg, num_robots: int, device: str):
        ...
        # create buffers
        # -- commands
        self.v_des = torch.zeros(num_robots, 2, device=device)
        self.yaw_rate_des = torch.zeros(num_robots, 1, device=device)
        # -- gains
